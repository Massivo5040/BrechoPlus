...
// Esse são os imports importantes
...
export default function Home() {
  ...
  // Aqui eu to pegando os dados do usuário logado (eu não usei aqui, mas é útil saber)
  ...
  // Essa função é a mais importante
  // Aqui eu acesso a coleção e carrega todas a roupas que estão lá
